...
const connection = mysql.createConnection({
    ...
    user: process.env.DB_USER || 'root', // Переменная окружения или значение по умолчанию
    password: process.env.DB_PASSWORD || 'qazwsxedc1234rfvtgb1234', // Переменная окружения или значение по умолчанию
